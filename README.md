...
I'm **Kyithar Hein** (キィターヘイン) — an AI engineer with **6+ years** in AI/ machine learning, including **3+ years** building **autonomous-driving & safety systems**. For the last **2+ years** I've worked in **blockchain / web3** — building **Rust MEV & mempool infrastructure** and doing **smart-contract security & bug bounty hunting**.
